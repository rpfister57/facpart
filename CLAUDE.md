...
`inoutEllipse()`, `mu2()`, and `mu2df()` have no `output` parameter — they always return their value directly. All other exported functions follow the `output = TRUE/FALSE` convention.
